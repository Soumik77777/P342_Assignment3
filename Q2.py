...
'''
A3/Q2. Write a Gauss-Jordan code with partial pivoting and solve the following set of linear equations.
2y +5z =1
3x -y +2z =-2
x -y +3z =3
'''
...
print("The solution set of the linear equations is:")
print("x=", vector[0])
print("y=", vector[1])
print("z=", vector[2])
...
'''
The solution set of the linear equations is:
x= -2.0
y= -2.0
z= 1.0
'''
